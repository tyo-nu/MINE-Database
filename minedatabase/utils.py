...
def neutralise_charges(mol: rdkit.Chem.rdchem.Mol, reactions=None) -> rdkit.Chem.rdchem.Mol:
...
def score_compounds(db: pymongo.database, compounds: list, model_id: str, parent_frac: float=0.75,
                    reaction_frac: float=0.25) -> List[dict]:
