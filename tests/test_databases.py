...
from minedatabase.databases import (MINE, write_compounds_to_mine, write_core_compounds, write_reactions_to_mine)
...
def test_insert_bulk_mine_compounds(test_db):
    ...
    smiles1 = 'CC(=O)O'
    smiles2 = 'CCN'
    compound_dict = [{'_id': 'test_cpd1', 'SMILES': smiles1},
